...
'
'  cscript //nologo linelist-geobase.vbs <linelist> <geobase>
'
'The two arguments are the same, in the same order, as
'linelist-geobase.applescript. Both paths are absolute.
'
...
If args.Count < 2 Then
  WScript.Echo "ERROR 1: linelist-geobase.vbs takes 2 arguments."
  WScript.Quit 1
End If
